...
async function showShop(interaction: ChatInputCommandInteraction, bot: DiscordBot) {
...
async function buyItem(interaction: ChatInputCommandInteraction, bot: DiscordBot, itemId: number) {
    await interaction.deferReply();
...
async function showBalance(interaction: ChatInputCommandInteraction, bot: DiscordBot) {
    await interaction.deferReply();
